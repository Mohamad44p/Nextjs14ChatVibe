    ...
    <div className="flex justify-center items-center h-screen font-primary p-10 m-2">
      ...
      <div className="h-[200px] diff aspect-[16/9]">
        <div className="diff-item-1">
          <div className="bg-primary text-primary-content text-9xl font-black grid place-content-center">Chat</div>
        </div>
        <div className="diff-item-2">
          <div className="bg-base-200 text-9xl font-black grid place-content-center">Vibe</div>
        </div>
